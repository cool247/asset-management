      ...
      children: [
...

        {
          ...
          children: [
            {
              element: (
                <Navigate to="/dashboard/report/meterWiseCoverage" replace />
              ),
              index: true,
            },
        ...
        },
        {
          ...
          children: [
            {
              element: <Navigate to="/dashboard/master/location" replace />,
              index: true,
            },
...
const GeneralEcommerce = lazy(() =>
  import("../pages/dashboard/GeneralEcommerce")
);
const GeneralAnalytics = lazy(() =>
  import("../pages/dashboard/GeneralAnalytics")
);
...
const EcommerceProductDetails = lazy(() =>
  import("../pages/dashboard/EcommerceProductDetails")
);
const EcommerceProductList = lazy(() =>
  import("../pages/dashboard/EcommerceProductList")
);
const EcommerceProductCreate = lazy(() =>
  import("../pages/dashboard/EcommerceProductCreate")
);
const EcommerceCheckout = lazy(() =>
  import("../pages/dashboard/EcommerceCheckout")
);
