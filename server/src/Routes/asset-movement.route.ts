...
import { createAssetMovement, } from "../Controllers/asset-movement.controller";
...
export const assetMovementRoutes = async (app: FastifyInstance) => {
  app.post("/create-new", { preHandler: [authorize(["admin"]), validate(createAssetMovementSchema)] }, createAssetMovement);
